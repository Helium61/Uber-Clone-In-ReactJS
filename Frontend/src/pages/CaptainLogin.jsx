    ...
    <div className="h-screen w-screen bg-white flex flex-col justify-between p-4">
      ...
      <div className="bg-white p-6 w-full max-w-md mx-auto flex flex-col justify-center">
        ...
        <p className="text-center text-sm text-gray-500">
          Join a Fleet{" "}
          <a href="/captain-signup" className="text-black">
            Register as a Captain
          </a>
        </p>
      </div>
      <div className="w-full max-w-md mx-auto mb-2">
        <Link to='/login' className=" flex items-center justify-center w-full py-2 bg-yellow-600 text-white rounded font-medium">
          Sign in as User
        </Link>
      </div>
    </div>
