    ...
    <div className="h-screen w-screen bg-white flex flex-col justify-between p-4">
      ...
      <div className="bg-white p-6 w-full max-w-md mx-auto flex flex-col justify-center">
        ...
        Already have an account ? {""}
          <a href="/captain-login" className="text-black">
            Login Here
          </a>
        </p>
      </div>
      <div className="text-center ">
 <p className="text-xs leading-tight">By proceeding,you consent to get calls,
  whatsApp or SMS messages, including by automated means, from Uber and
