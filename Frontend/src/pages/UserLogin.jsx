...
const UserLogin = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      // Show error toast with a custom message or error details if available
      const errorMessage =
  ...
  return (
    <div className="h-screen w-screen bg-white flex flex-col justify-between p-4">
      ...
      <div className="w-full max-w-md mx-auto mb-2">
        <Link
          to="/captain-login"
          className="flex items-center justify-center w-full py-2 bg-green-500 text-white rounded font-medium"
        >
          Sign in as Captain
        </Link>
      </div>
